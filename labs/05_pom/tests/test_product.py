...
def test_add_product_to_catalog(page: Page, product = "Apple"):

    # Given I am an admin user​
    login_page = LoginPage(page)
    login_page.navigate_to_login()
    login_page.admin_login("test_admin", "admin_test321")
    ...
    # Then the product should be listed in the app to be used
    expect(page.get_by_text("New Product")).to_be_visible()
   

def test_remove_product_from_catalog(page: Page, product = "Apple"):
