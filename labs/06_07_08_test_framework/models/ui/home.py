...
class HomePage:
    def __init__(self, page):
        ...
        self.login_header_main_title = page.get_by_text(
            'Nackademin Course App')
        ...
        self.login_label_have_account = page.get_by_text(
            "Don't have an account?")
        self.login_btn_signup = page.locator('#signup')

        self.base_url = os.getenv("FRONTEND_URL","http://infra-app-frontend-1:5173/")
